...
/***/ function(module, exports, __webpack_require__) {
	...
	var _checkHtml = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"~/assets/js/utils/check-html5\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	var _upload = __webpack_require__(86);

	var _upload2 = _interopRequireDefault(_upload);

	var _notify = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dbServer = __webpack_require__(84);
	            ...
	            "buttons": [{
	                ...
	                "buttons": [{
	                    ...
	                    "action": function action(evt, dt, node, conf) {
	                        ...
	                        try {
	                            for (var _iterator2 = (0, _getIterator3.default)(ids), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                                var id = _step2.value;
	                    ...
	                    "action": function action(evt, dt, node, conf) {
	                        if ($('tr.selected').length !== 1) {
	                            (0, _notify2.default)('Please select a single record to edit', 'warning');
	                            $('nav').click();
	                        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _teiDropzone = __webpack_require__(87);
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(20)(Function.call, __webpack_require__(109).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
